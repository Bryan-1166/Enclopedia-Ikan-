...
},
{
  ...
  kategori: "deepsea",
  gambar: "ikan_16.jpeg",
  habitat: "Perairan tropis dangkal di Samudra Hindia dan Pasifik, hidup di dalam anemon laut pada terumbu karang",
  ukuran: "7 - 11 cm",
  makanan: "Omnivora (plankton, alga, dan krustasea kecil)",
  kedalaman: "1 - 15 meter",
  status: "Risiko Rendah",
  morfologi: "Tubuh kecil berwarna oranye cerah dengan tiga garis putih dan sirip membulat.",
  deskripsi: "Ikan hias cerdas yang hidup bersimbiosis dengan anemon laut dan terlindungi dari sengatan berkat lapisan lendir khusus pada kulitnya.",
  catatan: "Semua ikan badut terlahir sebagai pejantan.",
  catatanUnik: "Dapat berganti kelamin menjadi betina dominan ketika diperlukan dalam kelompoknya."
},
{
  id: 17,
  ...
  kategori: "deepsea",
  gambar: "ikan_17.jpeg",
  habitat: "Perairan pesisir dan laut lepas beriklim sedang hingga tropis di seluruh dunia",
  ukuran: "4,5 - 6 meter",
  makanan: "Karnivora (anjing laut, ikan besar, dan mamalia laut)",
  kedalaman: "0 - 1200 meter",
  status: "Rentan",
  morfologi: "Tubuh besar berbentuk torpedo dengan punggung abu-abu dan bagian bawah putih.",
  deskripsi: "Predator puncak lautan yang memiliki kemampuan berburu sangat efektif menggunakan berbagai indra canggih.",
  catatan: "Memiliki indra elektroresepsi untuk mendeteksi aktivitas listrik mangsa.",
  catatanUnik: "Terkenal mampu melompat keluar air saat menyerang mangsa dalam perilaku yang disebut breaching."
},
{
  id: 18,
  nama: "Ikan Cupang",
  ...
  kategori: "freshwater",
  gambar: "ikan_18.jpeg",
  habitat: "Rawa, sawah, dan perairan dangkal yang tenang di Asia Tenggara",
  ukuran: "6 - 8 cm",
  makanan: "Karnivora (larva serangga, cacing kecil, dan zooplankton)",
  kedalaman: "Kurang dari 1 meter",
  status: "Belum Dievaluasi",
  morfologi: "Tubuh kecil dengan sirip panjang berwarna-warni yang sangat mencolok.",
  deskripsi: "Ikan hias populer yang dikenal sangat teritorial terutama terhadap sesama pejantan.",
  catatan: "Memiliki organ labirin yang memungkinkan mengambil oksigen langsung dari udara.",
  catatanUnik: "Mampu bertahan hidup di air dengan kadar oksigen rendah yang sulit dihuni banyak ikan lain."
},
{
  id: 19,
  nama: "Ikan Salmon Atlantik",
  latin: "Salmo salar",
  kategori: "freshwater",
  gambar: "ikan_19.jpeg",
  habitat: "Sungai air tawar dan Samudra Atlantik Utara",
  ukuran: "70 - 75 cm",
  makanan: "Karnivora (ikan kecil, udang, dan krustasea)",
  kedalaman: "Permukaan hingga 200 meter",
  status: "Risiko Rendah",
  morfologi: "Tubuh memanjang berwarna perak dengan bintik-bintik hitam pada bagian atas tubuh.",
  deskripsi: "Ikan migrasi yang menghabiskan hidupnya di laut namun kembali ke sungai asal untuk berkembang biak.",
  catatan: "Mampu mengenali sungai kelahirannya dengan bantuan penciuman yang sangat tajam.",
  catatanUnik: "Dapat berenang ribuan kilometer melawan arus sungai tanpa makan untuk mencapai lokasi pemijahan."
},
{
  id: 20,
  nama: "Ikan Tuna Sirip Biru",
  latin: "Thunnus thynnus",
  kategori: "deepsea",
  gambar: "ikan_20.jpeg",
  habitat: "Samudra terbuka beriklim sedang dan tropis di seluruh dunia",
  ukuran: "2 - 3 meter",
  makanan: "Karnivora (ikan kecil, cumi-cumi, dan krustasea)",
  kedalaman: "0 - 1000 meter",
  status: "Terancam Punah",
  morfologi: "Tubuh besar berbentuk torpedo dengan sirip punggung dan ekor yang kuat untuk berenang cepat.",
  deskripsi: "Perenang cepat yang mampu melakukan migrasi lintas samudra dalam jarak sangat jauh.",
